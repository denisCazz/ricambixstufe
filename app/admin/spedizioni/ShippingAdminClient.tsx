      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="text-sm text-muted mt-0.5">
            Queste tariffe valgono al checkout e nella pagina Come acquistare. Le zone Italia sono al netto: l&apos;IVA viene aggiunta in automatico.
          </p>
        </div>
        <button
          type="button"
        ...
        <div className="grid sm:grid-cols-2 gap-5">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              className="w-full"
            />
            <p className="text-xs text-muted">Aggiunto al totale per pagamenti in contrassegno. Compare anche in Come acquistare.</p>
          </div>
          <div className="space-y-1.5">
